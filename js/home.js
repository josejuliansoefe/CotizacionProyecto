! function(e, t) {
    ...
    function E(e) {
        var t = he,
            n = Ke[e];
        return n || (n = N(e, t), "none" !== n && n || (Qe = (Qe || ie("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = (Qe[0].contentWindow || Qe[0].contentDocument).document, t.write(), t.close(), n = N(e, t), Qe.detach()), Ke[e] = n), n
    }
    ...
    function M(e, t, n) {
        for (var r, i = (yt[t] || []).concat(yt["*"]), o = 0, a = i.length; a > o; o++)
    ...
    function F(e, t, n) {
        ...
        if (ie.isEmptyObject(d)) "inline" === ("none" === u ? E(e.nodeName) : u) && (f.display = u);
        else {
    ...
    function B(e, t, n) {
        var r, i, o = 0,
            ...
            l = function() {
                if (i) return !1;
                for (var t = ft || q(), n = Math.max(0, u.startTime + u.duration - t), r = n / u.duration || 0, o = 1 - r, a = 0, l = u.tweens.length; l > a; a++) u.tweens[a].run(o);
    ...
    function I(e, t, n, r) {
        ...
        if (ie.isArray(t)) ie.each(t, function(t, i) {
            n || Xt.test(e) ? r(e, i) : I(e + "[" + ("object" == typeof i ? t : "") + "]", i, n, r)
        });
    ...
    var ue = function(e) {
        ...
        function m(e, t, n, i, o, a) {
            return i && !i[O] && (i = m(i)), o && !o[O] && (o = m(o, a)), r(function(r, a, s, l) {
                var u, c, d, f = [],
                    ...
                    b = n ? o || (r ? e : g || i) ? [] : a : y;
                if (n && n(y, b, s, l), i)
                    for (u = h(b, m), i(u, [], s, l), c = u.length; c--;)(d = u[c]) && (b[m[c]] = !(y[m[c]] = d));
                if (r) {
                    if (o || e) {
                        if (o) {
        ...
        var y, b, x, w, T, C, N, E, k, S, A, D, j, L, H, q, _, M, F, O = "sizzle" + 1 * new Date,
            B = e.document,
            P = 0,
            R = 0,
            W = n(),
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && y) {
                                for (c = g[O] || (g[O] = {}), u = c[e] || [], p = u[0] === P && u[1], f = u[0] === P && u[2], d = p && g.childNodes[p]; d = ++p && d && d[m] || (f = p = 0) || h.pop();)
    ...
    ie.event = {
        ...
        add: function(e, t, n, r, i) {
            ...
            if (g) {
                for (n.handler && (l = n, n = l.handler, i = l.selector), n.guid || (n.guid = ie.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || (c = g.handle = function(e) {
                    ...
                    }, c.elem = e), t = (t || "").match(ye) || [""], s = t.length; s--;) o = _e.exec(t[s]) || [], p = m = o[1], h = (o[2] || "").split(".").sort(), p && (u = ie.event.special[p] || {}, p = (i ? u.delegateType : u.bindType) || p, u = ie.event.special[p] || {}, d = ie.extend({
                    type: p,
                    origType: m,
                    data: r,
                    handler: n,
        ...
        trigger: function(t, n, r, i) {
            ...
            if (s = c = r = r || he, 3 !== r.nodeType && 8 !== r.nodeType && !qe.test(p + ie.event.triggered) && (p.indexOf(".") >= 0 && (h = p.split("."), p = h.shift(), h.sort()), a = p.indexOf(":") < 0 && "on" + p, t = t[ie.expando] ? t : new ie.Event(p, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : ie.makeArray(n, [t]), u = ie.event.special[p] || {}, i || !u.trigger || !1 !== u.trigger.apply(r, n))) {
                ...
                for (d = 0;
                    (s = f[d++]) && !t.isPropagationStopped();) t.type = d > 1 ? l : u.bindType || p, o = (ie._data(s, "events") || {})[t.type] && ie._data(s, "handle"), o && o.apply(s, n), (o = a && s[a]) && o.apply && ie.acceptData(s) && (t.result = o.apply(s, n), !1 === t.result && t.preventDefault());
    ...
    Je.optgroup = Je.option, Je.tbody = Je.tfoot = Je.colgroup = Je.caption = Je.thead, Je.th = Je.td, ie.extend({
        clone: function(e, t, n) {
            ...
            if (ne.html5Clone || ie.isXMLDoc(e) || !Oe.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (Ge.innerHTML = e.outerHTML, Ge.removeChild(o = Ge.firstChild)), !(ne.noCloneEvent && ne.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ie.isXMLDoc(e)))
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, l, u, c, d = e.length, f = m(t), p = [], h = 0; d > h; h++)
                ...
                if (!ne.leadingWhitespace && Be.test(o) && p.push(t.createTextNode(Be.exec(o)[0])), !ne.tbody)
                    for (o = "table" !== l || We.test(o) ? "<table>" !== c[1] || We.test(o) ? 0 : s : s.firstChild, i = o && o.childNodes.length; i--;) ie.nodeName(u = o.childNodes[i], "tbody") && !u.childNodes.length && o.removeChild(u);
    ...
    e.getComputedStyle ? (Ze = function(t) {
        ...
        return n = n || Ze(e), a = n ? n.getPropertyValue(t) || n[t] : void 0, n && ("" !== a || ie.contains(e.ownerDocument, e) || (a = ie.style(e, t)), nt.test(a) && tt.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i,
    ...
    ie.extend({
        ...
        style: function(e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (o = typeof n, "string" === o && (i = lt.exec(n)) && (n = (i[1] + 1) * i[2] + parseFloat(ie.css(e, t)), o = "number"), null != n && n === n && ("number" !== o || ie.cssNumber[s] || (n += "px"), ne.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, r))))) try {
                    l[t] = n
                } catch (e) {}
            }
        },
    ...
    ie.Animation = ie.extend(B, {
            tweener: function(e, t) {
                ...
                for (var n, r = 0, i = e.length; i > r; r++) n = e[r], yt[n] = yt[n] || [], yt[n].unshift(t)
            },
    ...
    ie.fn.extend({
        ...
        removeAttr: function(e, t) {
            var n, r, i = 0,
                o = t && t.match(ye);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = ie.propFix[n] || n, ie.expr.match.bool.test(n) ? Et && Nt || !Ct.test(n) ? e[r] = !1 : e[ie.camelCase("default-" + n)] = e[r] = !1 : ie.attr(e, n, ""), e.removeAttribute(Nt ? n : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        set: function(e, t, n) {
            return !1 === t ? ie.removeAttr(e, n) : Et && Nt || !Ct.test(n) ? e.setAttribute(!Nt && ie.propFix[n] || n, n) : e[ie.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, ie.each(ie.expr.match.bool.source.match(/\w+/g), function(e, t) {
        var n = Tt[t] || ie.find.attr;
        Tt[t] = Et && Nt || !Ct.test(t) ? function(e, t, r) {
            var i, o;
            return r || (o = Tt[t], Tt[t] = i, i = null != n(e, t, r) ? t.toLowerCase() : null, Tt[t] = o), i
        } : function(e, t, n) {
            return n ? void 0 : e[ie.camelCase("default-" + t)] ? t.toLowerCase() : null
        }
    }), Et && Nt || (ie.attrHooks.value = {
        set: function(e, t, n) {
    ...
    Ht = Rt.exec(qt.toLowerCase()) || [], ie.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        ajax: function(e, t) {
            ...
            if (h.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, d.url = ((e || d.url || qt) + "").replace(_t, "").replace(Pt, Ht[1] + "//"), d.type = t.method || t.type || d.method || d.type, d.dataTypes = ie.trim(d.dataType || "*").toLowerCase().match(ye) || [""], null == d.crossDomain && (r = Rt.exec(d.url.toLowerCase()), d.crossDomain = !(!r || r[1] === Ht[1] && r[2] === Ht[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (Ht[3] || ("http:" === Ht[1] ? "80" : "443")))), d.data && d.processData && "string" != typeof d.data && (d.data = ie.param(d.data, d.traditional)), R(Wt, d, t, w), 2 === b) return w;
    ...
    ie.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !ie(this).is(":disabled") && Jt.test(this.nodeName) && !Vt.test(e) && (this.checked || !De.test(e))
            }).map(function(e, t) {
                var n = ie(this).val();
    ...
    }), ne.cors = !!Qt && "withCredentials" in Qt, (Qt = ne.ajax = !!Qt) && ie.ajaxTransport(function(e) {
    ...
    ie.ajaxSetup({
        ...
        return s || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = ie.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Zt, "$1" + i) : !1 !== t.jsonp && (t.url += (jt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
...
$(document).on("ready", function() {
    function e() {
        ...
        function t() {
            for (var e = c.useMultipliers, t = e ? 1 : 0, n = 0; n < b.length; n++) e ? t *= b[n].answerWeight : t += b[n].answerWeight * c.pricePerHour;
        ...
        function r() {
            i(), ga("multidomain.set", "page", "/ccm-" + c.appType), ga("multidomain.send", "pageview"), l.initial.fadeIn(600), o()
        }

        function s() {
            i(), l.results.fadeIn(600), o(), ga("multidomain.set", "page", "/ccm-" + c.appType + "/result"), ga("multidomain.send", "pageview"), $(".js--form-questions").val(t()), $(".js--form-estimate").val(t())
        }
        ...
        function d(e) {
            i(), n(), ga("multidomain.set", "page", "/ccm-" + c.appType + "/step" + e), ga("multidomain.send", "pageview"), l.questions.filter('[data-question-id="' + e + '"]').fadeIn(600), o()
        }
        ...
        function m() {
            for (var e = b.length - 1; e >= 0; e--) {
                var n = b[e],
                    ...
                    o = n.answerText.trim(),
                    i = n.questionId,
                    r = l.results.find(".js--result").filter('[data-question-id="' + i + '"]');
                r.find(".js--result-answer").text(o), r.find(".js--result-image").attr({
                    src: "img/" + "/answer-" + i + "-" + a + ".png",
                    alt: o
                })
            }
            var s = t();
        ...
        function v() {
            l.questions.find(".answer").removeClass("selected"), b = [], x = !1, r()
        }
        ...
        function w(e) {
            for (var t = b.length - 1; t >= 0; t--) b[t].questionId === e.questionId && (b[t] = e)
        }
        ...
        function y(e, t) {
            ...
            return e.data("pph") && (c.pricePerHour = n.answerWeight, n.answerWeight = 0), n
        }
        ...
        function j(t, n) {
            var a = l.questions.filter('[data-question-id="' + n + '"]'),
                ...
                i = y(a, o);
            a.find(".answer").removeClass("selected"), o.addClass("selected"), e() || !T(i.questionId) ? w(i) : h(i);
        ...
        function M() {
            for (var e = $("#quoteForm"), t = e.find('[name="description"]').val(), n = e.find('[name="email"]').val(), a = e.find('[name="phone"]').val(), o = e.find('[name="name"]').val(), i = "", r = 0; r < b.length; r++) {
                var s = b[r];
                i += "<li>", i += "<span>" + s.questionId + " - " + s.questionText + ": </span>", i += "<b>" + s.answerText + "</b>", i += "</li>"
            }
    ...
    var l = {
        ...
        d = new e;
    l.initial.on("click", ".js--start", t), l.questions.on("click", ".js--answer", n), l.questions.on("click", ".js--previous", o), l.results.on("click", ".js--change", a), l.results.on("click", ".js--restart", i), l.results.on("click", ".js--toggle-results", r), l.results.on("click", ".js--start-project", s), $("#quoteForm").on("click", ".js--form-send", u),
        function() {
...
! function() {
    ...
    function c(t) {
        return new n(function(e, n) {
            var o = 0,
                a = [];
            0 == t.length && e(a);
            for (var s = 0; s < t.length; s += 1) i(t[s]).c(function(n) {
                return function(i) {
    ...
    }, window.Promise || (window.Promise = n, window.Promise.resolve = i, window.Promise.reject = o, window.Promise.race = l, window.Promise.all = c, window.Promise.prototype.then = n.prototype.c, window.Promise.prototype.catch = n.prototype.g)
}(),
function() {
    function t(t, e) {
        ...
        return new Promise(function(t, i) {
            if (c() && !r()) {
                var p = new Promise(function(t, e) {
                        function n() {
                            (new Date).getTime() - m >= h ? e() : document.fonts.load(d(s, '"' + s.family + '"'), l).then(function(e) {
                ...
                function e() {
                    var e;
                    (e = -1 != v && -1 != y || -1 != v && -1 != g || -1 != y && -1 != g) && ((e = v != y && v != g && y != g) || (null === f && (e = /AppleWebKit\/([0-9]+)(?:\.([0-9]+))/.exec(window.navigator.userAgent), f = !!e && (536 > parseInt(e[1], 10) || 536 === parseInt(e[1], 10) && 11 >= parseInt(e[2], 10))), e = f && (v == b && y == b && g == b || v == E && y == E && g == E || v == x && y == x && g == x)), e = !e), e && (N.parentNode && N.parentNode.removeChild(N), clearTimeout(u), t(s))
                }

                function r() {
                    if ((new Date).getTime() - m >= h) N.parentNode && N.parentNode.removeChild(N), i(s);
                    else {
                        var t = document.hidden;
                        !0 !== t && void 0 !== t || (v = c.a.offsetWidth, y = p.a.offsetWidth, g = w.a.offsetWidth, e()), u = setTimeout(r, 50)
                    }
                }
                var c = new n(l),
                    p = new n(l),
                ...
                N.dir = "ltr", o(c, d(s, "sans-serif")), o(p, d(s, "serif")), o(w, d(s, "monospace")), N.appendChild(c.a), N.appendChild(p.a), N.appendChild(w.a), document.body.appendChild(N), b = c.a.offsetWidth, E = p.a.offsetWidth, x = w.a.offsetWidth, r(), a(c, function(t) {
                    v = t, e()
                }), o(c, d(s, '"' + s.family + '",sans-serif')), a(p, function(t) {
                    y = t, e()
                }), o(p, d(s, '"' + s.family + '",serif')), a(w, function(t) {
                    g = t, e()
                }), o(w, d(s, '"' + s.family + '",monospace'))
            })
        })
    }, "object" == typeof module ? module.exports = s : (window.FontFaceObserver = s, window.FontFaceObserver.prototype.load = s.prototype.load)
}();
